      ...
      <div className="inside music">
        <div className="grid-container-music">
          <div className="grid-intro-music text-music">
            <p>Music is a big part of my life, and has become my side hustle. I license all types of music for TV, film, the web and video games. Here's a taste of some pop music for your listening pleasure!</p>
          </div>
